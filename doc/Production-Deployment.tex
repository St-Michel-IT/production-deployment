...
- hosts: gunicorn
  ...
  - name: Copy Spring Boot Application
    copy:
      ...
      dest: /home/chrichri/helloworld-0.0.1-SNAPSHOT.jar
  - name: Run Spring Boot Application
    shell: nohup java -jar /home/chrichri/helloworld-0.0.1-SNAPSHOT.jar &
            \end{lstlisting}
    \end{frame}
...
db_data: {}
    ...
    \begin{frame}
        ...
        Exécuter l'application Spring Boot \textquote{Dockerisée} de l'avant dernier exercice dans le MicroK8s de la VM du cluster Proxmox.
        \bigbreak
